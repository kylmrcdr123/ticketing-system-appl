package com.rocs.ticketing.system.utils.security.enumeration;

import static com.rocs.ticketing.system.utils.security.constant.Authority.*;
...
public enum Role {
    ...
    /** Role for MIS staff with read, create and update access. */
    ROLE_MISSTAFF(MISSTAFF_AUTHORITIES),
